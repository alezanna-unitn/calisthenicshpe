...
video_path = r'C:\Users\aless\TestMediapipe\mediapipe\examples\pose_landmarker\python\planchevestitochiuso.mp4'
...
squad_x_tolerance = 50
squad_y_tolerance = 50
   ...
   # Trova i frame comuni tra i due video
    ...
    for frame_number in common_frames:
        ...
        for mp_joint in mp_frame:
            ...
            # Extract and combine joint data 
            processed_joint = {
